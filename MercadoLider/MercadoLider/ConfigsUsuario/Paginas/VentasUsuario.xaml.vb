Class VentasUsuario
    ...
    Private Sub cargaStockUsuario(paginaProductos As Integer)
        ...
        cargarALista()
        listaProductos = DAOProductos.encontrarVentasVendedor(persona)
        ...
        For index As Integer = 0 To 3
            ...
            If index <= recorrido Then
                ...
                Dim cantidadProducto As TextBox = gridcartas.Children(3)
                cantidadProducto.Text = "Cantidad: " + listaProductos(numeroProd).Cant.ToString()
    ...
    Private Sub cargarALista()
        ...
        listaCartas.Add(GridProductos.Children(0))
        listaCartas.Add(GridProductos.Children(1))
        listaCartas.Add(GridProductos.Children(2))
        listaCartas.Add(GridProductos.Children(3))
    End Sub
    ...
    Private Sub CargaFactura(sender As Object, e As RoutedEventArgs)
        Dim Factura As New FacturasUsuario
        menu.CargaElementos.Navigate(Factura)
    End Sub
End Class
